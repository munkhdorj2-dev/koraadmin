...
export const FEATURES = [
  ...
  'laundry', 'roomService', 'security24h', 'hotelShop', 'massage', 'sauna', 'pool', 'gym',
  'meetingRoom', 'transfer',
...
export const FEATURE_LABELS = {
  ...
  hotelShop: 'Буудлын дэлгүүр', massage: 'Массаж', sauna: 'Саун',
  pool: 'Бассейн / Jacuzzi', gym: 'Gym / фитнес', meetingRoom: 'Бизнес төв / meeting',
  transfer: 'Тосох хүргэх',
